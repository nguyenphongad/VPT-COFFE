...
public class SanPham_QuanLy_UI extends JPanel implements ActionListener, MouseListener{
	...
	public SanPham_QuanLy_UI() {
		...
		txtMaSP.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode("#B16E5C")), 
		...
		txtTenSP.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode("#B16E5C")), 
				BorderFactory.createEmptyBorder(5, 0, 5, 0)));
		...
		txtDonGia.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode("#B16E5C")), 
				BorderFactory.createEmptyBorder(5, 0, 5, 0)));
		...
		btnLuu.setBackground(Color.decode("#ffffff"));
		...
		JLabel lblTimKiemTheoTenSP = new JLabel("Tìm Theo Tên SP :");
	...
	private void themSP() {
		...
		if(spNew!=null) {
			if(new SanPham_DAO().themSanPham(spNew)) {
				...
				alertNotification("Thêm Sản Phẩm Không Thành Công");
			}
		}
	}
	...
	public SanPham convertSP() {
		...
		if(cmbTrangThaiSP.getSelectedItem().equals("Đang bán")) {
			trangThai = true;
		}else if (cmbTrangThaiSP.getSelectedItem().equals("Ngừng bán")){
			trangThai = false;
		}
