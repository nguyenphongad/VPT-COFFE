...
public class SanPham_UI extends JPanel {
	public SanPham_UI() {
		...
		tabbedPane.addTab(cusBanHang.getTextTab(), cusBanHang.getPathIcon(), cusBanHang.getComponent(), cusBanHang.getTip());
		...
		tabbedPane.addTab(cusSanPham.getTextTab(), cusSanPham.getPathIcon(), cusSanPham.getComponent(), cusSanPham.getTip());
